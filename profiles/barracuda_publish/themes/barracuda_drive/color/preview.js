...
(function ($) {
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      $('#preview #preview-main-menu-links a', form).css('color', $('#palette input[name="palette[mainmenucolor]"]', form).val());
      $('#preview #preview-main-menu', form).css('border-color', $('#palette input[name="palette[border]"]', form).val());
